from .serializers import (EarlyBirdDiscountSerializer, EarlyBirdDiscountUpdateSerializer)
from deals.models import EarlyBirdDiscount
...
class EarlyBirdDiscountManagerViewSet(LoggingMixin, CustomViewSet):
    ...
    def get_serializer_class(self):
        if self.action in ["update"]:
            self.serializer_class = EarlyBirdDiscountUpdateSerializer
        else:
            self.serializer_class = EarlyBirdDiscountSerializer
