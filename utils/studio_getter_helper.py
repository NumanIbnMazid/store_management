...
def get_studio_id_from_studio(selfObject, slug=None):
    try:
        ...
        elif not slug and not defaultSlug and selfObject.request.data.get("studio"):
...
def get_studio_id_from_store(selfObject, slug=None):
    try:
        ...
        elif not slug and not defaultSlug and selfObject.request.data.get("store"):
            related_object = populate_related_object_id(
...
def get_studio_id_from_space(selfObject, slug=None):
    try:
        ...
        elif not slug and not defaultSlug and selfObject.request.data.get("space"):
            related_object = populate_related_object_id(
...
def get_studio_id_from_option_category(selfObject, slug=None):
    try:
        ...
        elif not slug and not defaultSlug and selfObject.request.data.get("option_category"):
